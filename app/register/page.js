...
const Register = () => {
    ...
    return(
        <main className="h-screen pt-30 lg:pt-15 px-7 lg:px-60 lg:h-170">
            <form onSubmit={registerSubmit} className="registerForm bg-green-300 text-blue-600 px-5 lg:px-25 py-10 lg:pb-7 lg:pt-2">
                <h1>Register</h1>
                <label>Name</label>
                <div>
