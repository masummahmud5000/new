...
const Home = () => {
  return(
    <main className="flex flex-col items-center bg-blue-200 h-screen pt-15">
      ...
      <div className='mt-15 bg-red-300 px-8 py-3 text-lg rounded-xl text-blue-600'>সর্বনিম্ন ক্যাশ আউট চার্জ<span className='text-red-600 text-xl'> MT</span> তে</div>
      <div>
